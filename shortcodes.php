...
function sws_mg_items_cat_func($atts) {
	...
	$myCats=sws_list_categories($a['post_type'], array('depth'=>$a['depth'],'hide_title_if_empty'=>$a['hide_empty'],'show_count'=>$a['show_count'],'echo'=>0,'exclude'=>$a['exclude'],'show_option_all'=>$a['show_option_all'],'title_li'=>''));
